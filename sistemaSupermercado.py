...
class Sistema():
    def __init__(self):
        ...
        self.listaUsuario.append(ClienteSuper("Lucas", "...","774", "774", "1"))
...
##########     TELA INICIAL     ##########
    def GerenciaLogin(self, sockCli):
        ...
        while True:
            ...
            tipoRecebido = informacoesLogin[2]
            print("recebi: " + login + " : " + senha + " : " + tipoRecebido)
            for cli in self.listaUsuario:
                if login == cli.login and senha == cli.senha and tipoRecebido == cli.tipoCliente:
                    achou = 1
